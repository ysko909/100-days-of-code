...
- [オフィシャルのbodyPixのページ](https://ml5js.org/reference/api-BodyPix/)には「Returns "{raw}", "{maskBackground}", and "{maskPerson}".」と書いてあるのだが、**これは間違い**。実際は`backgroundMask`と`personMask`の
